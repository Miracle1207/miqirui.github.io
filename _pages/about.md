...
- **AI Agents**: Multi-Agent Systems, Reinforcement Learning (RL) agents, Large Language Model (LLM) agents, Population-agent system, Game Theory.

- **AI plus Economics**: Economic simulations, World Model, and Social simulations.
...
- **2025.12**: Attended [NeurIPS 2025](https://neurips.cc/) in San Diego, United State.
